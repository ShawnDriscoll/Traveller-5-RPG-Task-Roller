...
class Ui_aboutDialog(object):
    ...
    def retranslateUi(self, aboutDialog):
        ...
        self.textLabel.setText(_translate("aboutDialog", "<html><head/><body><p><span style=\" font-weight:600;\">Traveller5 Task Roller for Windows 11</span></p><p>Build: 0.3.1 (Beta)</p><p>Produced by Shawn Driscoll. Copyright (C) 2024.</p><p>Get the latest pydice manual at <a href=\"https://pydice.readthedocs.io/en/latest/\"><span style=\" text-decoration: underline; color:#0000ff;\">Read the Docs</span></a><br/>Visit blog at <a href=\"http://shawndriscoll.blogspot.com\"><span style=\" text-decoration: underline; color:#0000ff;\">shawndriscoll.blogspot.com</span></a><br/>For support, email <a href=\"mailto:shawndriscoll@hotmail.com?subject=Traveller5 Task Roller 0.3.1 (Beta)\"><span style=\" text-decoration: underline; color:#0000ff;\">shawndriscoll@hotmail.com</span></a></p><p>Qt GUI Toolkit is copyright (C) 2020 The Qt Company Ltd</p><p><br/></p><p>The Traveller game in all forms is owned by Far Future Enterprises. Copyright 1977 - 2024 Far Future Enterprises. Traveller is a registered trademark of Far Future Enterprises.</p></body></html>"))
