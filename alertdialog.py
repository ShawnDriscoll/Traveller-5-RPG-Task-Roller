...
class Ui_alertDialog(object):
    ...
    def retranslateUi(self, alertDialog):
        ...
        self.textLabel.setText(_translate("alertDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">Build 0.0.2 (Beta) of Traveller5 Task Roller has</span></p><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; color:#ff0000;\">EXPIRED</span><span style=\" font-size:10pt; font-weight:600;\">.</span></p><p align=\"center\"><span style=\" font-size:10pt;\">Check for a newer release from </span><a href=\"https://github.com/ShawnDriscoll/Traveller5-RPG-Task-Roller\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">GitHub</span></a><span style=\" font-size:10pt;\">.</span><br/><span style=\" font-size:10pt;\">For support, email </span><a href=\"mailto:shawndriscoll@hotmail.com?subject=Traveller5 Task Roller 0.0.2 [EXPIRED Beta]\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">shawndriscoll@hotmail.com</span></a></p><p align=\"center\"><span style=\" font-size:10pt;\">Thank you for participating.</span></p></body></html>"))
